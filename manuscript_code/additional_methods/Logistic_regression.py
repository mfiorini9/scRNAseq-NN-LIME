...
par_m4_train = '/lustre03/project/6070393/COMMON/samplepooling/MF/PD_machine_learning/astro/m4_scETM_train.h5ad'
...
## Logistic regression ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
par_metric_summary_frame_LR = '/lustre03/project/6070393/COMMON/samplepooling/MF/PD_machine_learning/astro/LR_5_fold_summary_eval.csv'
par_confusion_matrix_combo_LR = '/lustre03/project/6070393/COMMON/samplepooling/MF/PD_machine_learning/astro/LR_confusion_matrix_summary_eval.csv'
...
############################## Method 1 ##############################
## fold 1
tuning_model_m1_fold1 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m1_fold1 = tuning_model_m1_fold1.fit(m1_X_train_fold1, m1_y_train_fold1)
prediction_val, accuracy_val = validation(tuning_model_classifier_m1_fold1, m1_X_test_fold1, m1_y_test_fold1) 
## fold 2
tuning_model_m1_fold2 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m1_fold2 = tuning_model_m1_fold2.fit(m1_X_train_fold2, m1_y_train_fold2)
prediction_val, accuracy_val = validation(tuning_model_classifier_m1_fold2, m1_X_test_fold2, m1_y_test_fold2) 
## fold 3
tuning_model_m1_fold3 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m1_fold3 = tuning_model_m1_fold3.fit(m1_X_train_fold3, m1_y_train_fold3)
prediction_val, accuracy_val = validation(tuning_model_classifier_m1_fold3, m1_X_test_fold3, m1_y_test_fold3) 
## fold 4
tuning_model_m1_fold4 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m1_fold4 = tuning_model_m1_fold4.fit(m1_X_train_fold4, m1_y_train_fold4)
prediction_val, accuracy_val = validation(tuning_model_classifier_m1_fold4, m1_X_test_fold4, m1_y_test_fold4) 
## fold 5
tuning_model_m1_fold5 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m1_fold5 = tuning_model_m1_fold5.fit(m1_X_train_fold5, m1_y_train_fold5)
prediction_val, accuracy_val = validation(tuning_model_classifier_m1_fold5, m1_X_test_fold5, m1_y_test_fold5) 

############################## Method 2 ##############################
## fold 1
tuning_model_m2_fold1 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m2_fold1 = tuning_model_m2_fold1.fit(m2_X_train_fold1, m2_y_train_fold1)
prediction_val, accuracy_val = validation(tuning_model_classifier_m2_fold1, m2_X_test_fold1, m2_y_test_fold1) 
## fold 2
tuning_model_m2_fold2 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m2_fold2 = tuning_model_m2_fold2.fit(m2_X_train_fold2, m2_y_train_fold2)
prediction_val, accuracy_val = validation(tuning_model_classifier_m2_fold2, m2_X_test_fold2, m2_y_test_fold2) 
## fold 3
tuning_model_m2_fold3 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m2_fold3 = tuning_model_m2_fold3.fit(m2_X_train_fold3, m2_y_train_fold3)
prediction_val, accuracy_val = validation(tuning_model_classifier_m2_fold3, m2_X_test_fold3, m2_y_test_fold3) 
## fold 4
tuning_model_m2_fold4 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m2_fold4 = tuning_model_m2_fold4.fit(m2_X_train_fold4, m2_y_train_fold4)
prediction_val, accuracy_val = validation(tuning_model_classifier_m2_fold4, m2_X_test_fold4, m2_y_test_fold4) 
## fold 5
tuning_model_m2_fold5 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m2_fold5 = tuning_model_m2_fold5.fit(m2_X_train_fold5, m2_y_train_fold5)
prediction_val, accuracy_val = validation(tuning_model_classifier_m2_fold5, m2_X_test_fold5, m2_y_test_fold5) 

  
############################## Method 3 ##############################
## fold 1
tuning_model_m3_fold1 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m3_fold1 = tuning_model_m3_fold1.fit(m3_X_train_fold1, m3_y_train_fold1)
prediction_val, accuracy_val = validation(tuning_model_classifier_m3_fold1, m3_X_test_fold1, m3_y_test_fold1) 
## fold 2
tuning_model_m3_fold2 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m3_fold2 = tuning_model_m3_fold2.fit(m3_X_train_fold2, m3_y_train_fold2)
prediction_val, accuracy_val = validation(tuning_model_classifier_m3_fold2, m3_X_test_fold2, m3_y_test_fold2) 
## fold 3
tuning_model_m3_fold3 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m3_fold3 = tuning_model_m3_fold3.fit(m3_X_train_fold3, m3_y_train_fold3)
prediction_val, accuracy_val = validation(tuning_model_classifier_m3_fold3, m3_X_test_fold3, m3_y_test_fold3) 
## fold 4
tuning_model_m3_fold4 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m3_fold4 = tuning_model_m3_fold4.fit(m3_X_train_fold4, m3_y_train_fold4)
prediction_val, accuracy_val = validation(tuning_model_classifier_m3_fold4, m3_X_test_fold4, m3_y_test_fold4) 
## fold 5
tuning_model_m3_fold5 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m3_fold5 = tuning_model_m3_fold5.fit(m3_X_train_fold5, m3_y_train_fold5)
prediction_val, accuracy_val = validation(tuning_model_classifier_m3_fold5, m3_X_test_fold5, m3_y_test_fold5) 

############################## Method 4 ##############################
## fold 1
tuning_model_m4_fold1 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m4_fold1 = tuning_model_m4_fold1.fit(m4_X_train_fold1, m4_y_train_fold1)
prediction_val, accuracy_val = validation(tuning_model_classifier_m4_fold1, m4_X_test_fold1, m4_y_test_fold1) 
## fold 2
tuning_model_m4_fold2 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m4_fold2 = tuning_model_m4_fold2.fit(m4_X_train_fold2, m4_y_train_fold2)
prediction_val, accuracy_val = validation(tuning_model_classifier_m4_fold2, m4_X_test_fold2, m4_y_test_fold2) 
## fold 3
tuning_model_m4_fold3 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m4_fold3 = tuning_model_m4_fold3.fit(m4_X_train_fold3, m4_y_train_fold3)
prediction_val, accuracy_val = validation(tuning_model_classifier_m4_fold3, m4_X_test_fold3, m4_y_test_fold3) 
## fold 4
tuning_model_m4_fold4 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m4_fold4 = tuning_model_m4_fold4.fit(m4_X_train_fold4, m4_y_train_fold4)
prediction_val, accuracy_val = validation(tuning_model_classifier_m4_fold4, m4_X_test_fold4, m4_y_test_fold4) 
## fold 5
tuning_model_m4_fold5 = LogisticRegression(penalty = 'l1', C = 2.0, random_state = None, solver = 'liblinear', max_iter = 100) # use this solver because n_samples >> n_features
tuning_model_classifier_m4_fold5 = tuning_model_m4_fold5.fit(m4_X_train_fold5, m4_y_train_fold5)
prediction_val, accuracy_val = validation(tuning_model_classifier_m4_fold5, m4_X_test_fold5, m4_y_test_fold5) 
...
##### fold 1 #####
## prediction
prediction_test = tuning_model_m1_fold1.predict(X_test_m1)
predictions = tuning_model_classifier_m1_fold1.predict_proba(X_test_m1)
## accuracy
...
##### fold 2 #####
## prediction
prediction_test = tuning_model_m1_fold2.predict(X_test_m1)
predictions = tuning_model_classifier_m1_fold2.predict_proba(X_test_m1)
## accuracy
...
##### fold 3 #####
## prediction
prediction_test = tuning_model_m1_fold3.predict(X_test_m1)
predictions = tuning_model_classifier_m1_fold3.predict_proba(X_test_m1)
## accuracy
...
##### fold 4 #####
## prediction
prediction_test = tuning_model_m1_fold4.predict(X_test_m1)
predictions = tuning_model_classifier_m1_fold4.predict_proba(X_test_m1)
## accuracy
...
##### fold 5 #####
## prediction
prediction_test = tuning_model_m1_fold5.predict(X_test_m1)
predictions = tuning_model_classifier_m1_fold5.predict_proba(X_test_m1)
## accuracy
...
##### fold 1 #####
## prediction
prediction_test = tuning_model_m2_fold1.predict(X_test_m2)
predictions = tuning_model_classifier_m2_fold1.predict_proba(X_test_m2)
## accuracy
...
##### fold 2 #####
## prediction
prediction_test = tuning_model_m2_fold2.predict(X_test_m2)
predictions = tuning_model_classifier_m2_fold2.predict_proba(X_test_m2)
## accuracy
...
##### fold 3 #####
## prediction
prediction_test = tuning_model_m2_fold3.predict(X_test_m2)
predictions = tuning_model_classifier_m2_fold3.predict_proba(X_test_m2)
## accuracy
...
##### fold 4 #####
## prediction
prediction_test = tuning_model_m2_fold4.predict(X_test_m2)
predictions = tuning_model_classifier_m2_fold4.predict_proba(X_test_m2)
## accuracy
...
##### fold 5 #####
## prediction
prediction_test = tuning_model_m2_fold5.predict(X_test_m2)
predictions = tuning_model_classifier_m2_fold5.predict_proba(X_test_m2)
## accuracy
...
##### fold 1 #####
## prediction
prediction_test = tuning_model_m3_fold1.predict(X_test_m3)
predictions = tuning_model_classifier_m3_fold1.predict_proba(X_test_m3)
...
##### fold 2 #####
## prediction
prediction_test = tuning_model_m3_fold2.predict(X_test_m3)
predictions = tuning_model_classifier_m3_fold2.predict_proba(X_test_m3)
...
##### fold 3 #####
## prediction
prediction_test = tuning_model_m3_fold3.predict(X_test_m3)
predictions = tuning_model_classifier_m3_fold3.predict_proba(X_test_m3)
...
##### fold 4 #####
## prediction
prediction_test = tuning_model_m3_fold4.predict(X_test_m3)
predictions = tuning_model_classifier_m3_fold4.predict_proba(X_test_m3)
...
##### fold 5 #####
## prediction
prediction_test = tuning_model_m3_fold5.predict(X_test_m3)
predictions = tuning_model_classifier_m3_fold5.predict_proba(X_test_m3)
...
# export to csv file
df_index.to_csv(LR_par_cell_index_m3_fold5)

############################## Method 4 ##############################
##### fold 1 #####
## prediction
prediction_test = tuning_model_m4_fold1.predict(X_test_m4)
predictions = tuning_model_classifier_m4_fold1.predict_proba(X_test_m4)
...
##### fold 2 #####
## prediction
prediction_test = tuning_model_m4_fold2.predict(X_test_m4)
predictions = tuning_model_classifier_m4_fold2.predict_proba(X_test_m4)
...
##### fold 3 #####
## prediction
prediction_test = tuning_model_m4_fold3.predict(X_test_m4)
predictions = tuning_model_classifier_m4_fold3.predict_proba(X_test_m4)
...
##### fold 4 #####
## prediction
prediction_test = tuning_model_m4_fold4.predict(X_test_m4)
predictions = tuning_model_classifier_m4_fold4.predict_proba(X_test_m4)
...
##### fold 5 #####
## prediction
prediction_test = tuning_model_m4_fold5.predict(X_test_m4)
predictions = tuning_model_classifier_m4_fold5.predict_proba(X_test_m4)
...
df2.to_csv(par_metric_summary_frame_LR)
...
df.to_csv(par_confusion_matrix_combo_LR)
