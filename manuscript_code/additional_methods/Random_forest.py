## This script was used for random forest.
...
## Random forest ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
par_metric_summary_frame_RF = '/lustre03/project/6070393/COMMON/samplepooling/MF/PD_machine_learning/astro/RF_5_fold_summary_eval.csv'
par_confusion_matrix_combo_RF = '/lustre03/project/6070393/COMMON/samplepooling/MF/PD_machine_learning/astro/RF_confusion_matrix_summary_eval.csv'

###################################
# load library
# I will eventuallyy go through this and remove duplicates
###################################
## RF ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
import numpy as np
import pandas as pd
...
## Method 1 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# fold1
forest_m1_fold1 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m1_fold1 = forest_m1_fold1.fit(m1_X_train_fold1, m1_y_train_fold1)
m1_test_accuracy, y_pred_m1 = predict(forest_m1_fold1, m1_X_test_fold1, m1_y_test_fold1)
# fold2
forest_m1_fold2 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m1_fold2 = forest_m1_fold2.fit(m1_X_train_fold2, m1_y_train_fold2)
m1_test_accuracy, y_pred_m1 = predict(forest_m1_fold2, m1_X_test_fold2, m1_y_test_fold2)
# fold3
forest_m1_fold3 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m1_fold3 = forest_m1_fold3.fit(m1_X_train_fold3, m1_y_train_fold3)
m1_test_accuracy, y_pred_m1 = predict(forest_m1_fold3, m1_X_test_fold3, m1_y_test_fold3)
# fold4
forest_m1_fold4 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m1_fold4 = forest_m1_fold4.fit(m1_X_train_fold4, m1_y_train_fold4)
m1_test_accuracy, y_pred_m1 = predict(forest_m1_fold4, m1_X_test_fold4, m1_y_test_fold4)
# fold5
forest_m1_fold5 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m1_fold5 = forest_m1_fold5.fit(m1_X_train_fold5, m1_y_train_fold5)
m1_test_accuracy, y_pred_m1 = predict(forest_m1_fold5, m1_X_test_fold5, m1_y_test_fold5)

## Method 2 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# fold1
forest_m2_fold1 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m2_fold1 = forest_m2_fold1.fit(m2_X_train_fold1, m2_y_train_fold1)
m2_test_accuracy, y_pred_m2 = predict(forest_m2_fold1, m2_X_test_fold1, m2_y_test_fold1)
# fold2
forest_m2_fold2 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m2_fold2 = forest_m2_fold2.fit(m2_X_train_fold2, m2_y_train_fold2)
m2_test_accuracy, y_pred_m2 = predict(forest_m2_fold2, m2_X_test_fold2, m2_y_test_fold2)
# fold3
forest_m2_fold3 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m2_fold3 = forest_m2_fold3.fit(m2_X_train_fold3, m2_y_train_fold3)
m2_test_accuracy, y_pred_m2 = predict(forest_m2_fold3, m2_X_test_fold3, m2_y_test_fold3)
# fold4
forest_m2_fold4 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m2_fold4 = forest_m2_fold4.fit(m2_X_train_fold4, m2_y_train_fold4)
m2_test_accuracy, y_pred_m2 = predict(forest_m2_fold4, m2_X_test_fold4, m2_y_test_fold4)
# fold5
forest_m2_fold5 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m2_fold5 = forest_m2_fold5.fit(m2_X_train_fold5, m2_y_train_fold5)
m2_test_accuracy, y_pred_m2 = predict(forest_m2_fold5, m2_X_test_fold5, m2_y_test_fold5)

## Method 3 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# fold1
forest_m3_fold1 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m3_fold1 = forest_m3_fold1.fit(m3_X_train_fold1, m3_y_train_fold1)
m3_test_accuracy, y_pred_m3 = predict(forest_m3_fold1, m3_X_test_fold1, m3_y_test_fold1)
# fold2
forest_m3_fold2 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m3_fold2 = forest_m3_fold2.fit(m3_X_train_fold2, m3_y_train_fold2)
m3_test_accuracy, y_pred_m3 = predict(forest_m3_fold2, m3_X_test_fold2, m3_y_test_fold2)
# fold3
forest_m3_fold3 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m3_fold3 = forest_m3_fold3.fit(m3_X_train_fold3, m3_y_train_fold3)
m3_test_accuracy, y_pred_m3 = predict(forest_m3_fold3, m3_X_test_fold3, m3_y_test_fold3)
# fold4
forest_m3_fold4 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m3_fold4 = forest_m3_fold4.fit(m3_X_train_fold4, m3_y_train_fold4)
m3_test_accuracy, y_pred_m3 = predict(forest_m3_fold4, m3_X_test_fold4, m3_y_test_fold4)
# fold5
forest_m3_fold5 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m3_fold5 = forest_m3_fold5.fit(m3_X_train_fold5, m3_y_train_fold5)
m3_test_accuracy, y_pred_m3 = predict(forest_m3_fold5, m3_X_test_fold5, m3_y_test_fold5)

## Method 4 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# fold1
forest_m4_fold1 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m4_fold1 = forest_m4_fold1.fit(m4_X_train_fold1, m4_y_train_fold1)
m4_test_accuracy, y_pred_m4 = predict(forest_m4_fold1, m4_X_test_fold1, m4_y_test_fold1)
# fold2
forest_m4_fold2 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m4_fold2 = forest_m4_fold2.fit(m4_X_train_fold2, m4_y_train_fold2)
m4_test_accuracy, y_pred_m4 = predict(forest_m4_fold2, m4_X_test_fold2, m4_y_test_fold2)
# fold3
forest_m4_fold3 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m4_fold3 = forest_m4_fold3.fit(m4_X_train_fold3, m4_y_train_fold3)
m4_test_accuracy, y_pred_m4 = predict(forest_m4_fold3, m4_X_test_fold3, m4_y_test_fold3)
# fold4
forest_m4_fold4 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m4_fold4 = forest_m4_fold4.fit(m4_X_train_fold4, m4_y_train_fold4)
m4_test_accuracy, y_pred_m4 = predict(forest_m4_fold4, m4_X_test_fold4, m4_y_test_fold4)
# fold5
forest_m4_fold5 = RandomForestClassifier(n_estimators=100, criterion='gini', bootstrap=True, min_samples_split=2, min_samples_leaf=1)
forest_m4_fold5 = forest_m4_fold5.fit(m4_X_train_fold5, m4_y_train_fold5)
m4_test_accuracy, y_pred_m4 = predict(forest_m4_fold5, m4_X_test_fold5, m4_y_test_fold5)
...
##### fold1 #####
## prediction
prediction_test = forest_m1_fold1.predict(X_test_m1)
predictions = forest_m1_fold1.predict_proba(X_test_m1)
## accuracy
...
##### fold2 #####
## prediction
prediction_test = forest_m1_fold2.predict(X_test_m1)
predictions = forest_m1_fold2.predict_proba(X_test_m1)
## accuracy
...
##### fold3 #####
## prediction
prediction_test = forest_m1_fold3.predict(X_test_m1)
predictions = forest_m1_fold3.predict_proba(X_test_m1)
## accuracy
...
##### fold4 #####
## prediction
prediction_test = forest_m1_fold4.predict(X_test_m1)
predictions = forest_m1_fold4.predict_proba(X_test_m1)
## accuracy
...
##### fold5 #####
## prediction
prediction_test = forest_m1_fold5.predict(X_test_m1)
predictions = forest_m1_fold5.predict_proba(X_test_m1)
## accuracy
...
##### fold1 #####
## prediction
prediction_test = forest_m2_fold1.predict(X_test_m2)
predictions = forest_m2_fold1.predict_proba(X_test_m2)
## accuracy
...
##### fold2 #####
## prediction
prediction_test = forest_m2_fold2.predict(X_test_m2)
predictions = forest_m2_fold2.predict_proba(X_test_m2)
## accuracy
...
##### fold3 #####
## prediction
prediction_test = forest_m2_fold3.predict(X_test_m2)
predictions = forest_m2_fold3.predict_proba(X_test_m2)
## accuracy
...
##### fold4 #####
## prediction
prediction_test = forest_m2_fold4.predict(X_test_m2)
predictions = forest_m2_fold4.predict_proba(X_test_m2)
## accuracy
...
##### fold5 #####
## prediction
prediction_test = forest_m2_fold5.predict(X_test_m2)
predictions = forest_m2_fold5.predict_proba(X_test_m2)
## accuracy
...
##### fold 1 #####
## prediction
prediction_test = forest_m3_fold1.predict(X_test_m3)
predictions = forest_m3_fold1.predict_proba(X_test_m3)
...
##### fold2 #####
## prediction
prediction_test = forest_m3_fold2.predict(X_test_m3)
predictions = forest_m3_fold2.predict_proba(X_test_m3)
...
##### fold3 #####
## prediction
prediction_test = forest_m3_fold3.predict(X_test_m3)
predictions = forest_m3_fold3.predict_proba(X_test_m3)
...
##### fold4 #####
## prediction
prediction_test = forest_m3_fold4.predict(X_test_m3)
predictions = forest_m3_fold4.predict_proba(X_test_m3)
...
##### fold5 #####
## prediction
prediction_test = forest_m3_fold5.predict(X_test_m3)
predictions = forest_m3_fold5.predict_proba(X_test_m3)
...
##### fold 1 #####
## prediction
prediction_test = forest_m4_fold1.predict(X_test_m4)
predictions = forest_m4_fold1.predict_proba(X_test_m4)
...
##### fold2 #####
## prediction
prediction_test = forest_m4_fold2.predict(X_test_m4)
predictions = forest_m4_fold2.predict_proba(X_test_m4)
...
##### fold3 #####
## prediction
prediction_test = forest_m4_fold3.predict(X_test_m4)
predictions = forest_m4_fold3.predict_proba(X_test_m4)
...
##### fold4 #####
## prediction
prediction_test = forest_m4_fold4.predict(X_test_m4)
predictions = forest_m4_fold4.predict_proba(X_test_m4)
...
##### fold5 #####
## prediction
prediction_test = forest_m4_fold5.predict(X_test_m4)
predictions = forest_m4_fold5.predict_proba(X_test_m4)
...
df.to_csv(RF_par_LIME_out_m4_fold5)
...
df2.to_csv(par_metric_summary_frame_RF)
...
df.to_csv(par_confusion_matrix_combo_RF)
