## This script was used to split the Wang object. We use astrocytes as an example. 
...
###################################
par_ann_data = "/home/fiorini9/scratch/machine_learning/base_seurat_objects/Wang.h5ad"
...
## one we want to keep
keep_names = ["PD_17_HAAB", "PD_12_HBCX", "PD_11_HBEH", "PD_13_HBFS", "PD_20_HBRE", "control_7_HctYM", "control_2_HctYH", "control_4_HctZZA", "control_5_HctZP", "control_9_HBHF", "control_6_HCT16HCV"]

adata = adata[adata.obs['Sample_ID'].isin(keep_names)]
set(adata.obs['Sample_ID'])
