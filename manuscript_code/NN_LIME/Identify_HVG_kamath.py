## This script was used to identify HVGs in the Kamath object. We use astrocytes as an example. 
...
m1_5000_genes_train.obs['Disease_Status'] = m1_5000_genes_train.obs['Disease_Status'].replace({'Parkinson disease': 1, 'normal': 0})
...
## Rename disease ontology
m1_5000_genes_test.obs['Disease_Status'] = m1_5000_genes_test.obs['Disease_Status'].replace({'Parkinson disease': 1, 'normal': 0})
